...
Under "My Projects" (the folder icon in the left sidebar), you can set up your own projects. This acts as a digital container for all materials related to a specific task or research project. Use it to keep your chats organized, especially if you have multiple conversations on the same topic. To get started, click '+ Add Project' at the top right of the screen. Within a project, you can collect chats, prompts, and personas in one place. This lets you easily navigate back to earlier prompts and responses, making it simple to pick up right where you left off.
